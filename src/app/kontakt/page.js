...
const StyledIcon = ({ className = '', ...props }) => (
  <FontAwesomeIcon
    className={`text-3xl text-success-500 flex-shrink-0 ${className}`}
    {...props}
  />
);
...
const ContactPerson = ({ children, className = '', ...props }) => (
  <h3
    className={`flex items-center justify-center pt-8 pb-8 text-2xl md:text-3xl font-semibold text-foreground ${className}`}
    {...props}
  >
    {children}
  </h3>
...
export const metadata = {
  ...
  description: `Kontaktujte nás pro arboristické služby. Sídlo ve Vimperku, pobočka v Praze. Lukáš Kačer - certifikovaný arborista s ${getYearsSinceFounded()}+ lety zkušeností.`,
  openGraph: {
    title: 'Kontakt - Arbovert s.r.o. | Arboristické služby',
    description:
      'Kontaktujte nás pro arboristické služby. Sídlo ve Vimperku, pobočka v Praze. Lukáš Kačer - certifikovaný arborista.',
    images: [
      {
          ...
          <Card className="p-12 md:p-16 mb-10 shadow-none border-2 border-default-200 rounded-2xl">
            ...
            <div className="grid grid-cols-12 gap-8 md:gap-10">
              ...
              <div className="col-span-12 md:col-span-4 flex flex-col">
                ...
                <h3 className="text-xl md:text-2xl font-semibold mb-4 mt-6 text-foreground">
                  DIČ
                </h3>
                <p className="text-lg text-default-600 leading-relaxed">
                  CZ02059690
