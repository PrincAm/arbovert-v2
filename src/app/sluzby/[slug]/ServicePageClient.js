  ...
  return (
    <StyledContainer>
      <div className="max-w-screen-lg mx-auto w-full pt-20 pb-20 px-6">
        ...
        <div className="grid grid-cols-12 gap-8 md:gap-10 mb-10 bg-white rounded-2xl p-8 md:p-12 border-2 border-default-200">
          <div className="col-span-12 md:col-span-7 flex flex-col gap-6">
            <h2 className="text-3xl md:text-4xl font-semibold text-foreground">Arbovert</h2>
            <div className="space-y-4">
              <p className="block font-bold text-lg md:text-xl text-foreground">{service.description}</p>
              <p className="block font-bold text-lg md:text-xl text-foreground">{service.longDescription}</p>
              <p className="block font-bold text-lg md:text-xl text-foreground mt-6">
                Jaké služby nabízíme?
              </p>
              <ol className="list-decimal list-inside space-y-2 text-lg text-default-600 leading-relaxed">
              ...
              <p className="block mt-6 font-bold text-lg md:text-xl text-foreground">{service.question}</p>
            </div>
          </div>
