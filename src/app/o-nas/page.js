...
export const metadata = {
  ...
  description: `Arbovert s.r.o. - tým certifikovaných arboristů s ${getYearsSinceFounded()}+ lety zkušeností. Specializujeme se na rizikové kácení, ošetřování stromů, inventarizace dřevin a údržbu zahrad.`,
  openGraph: {
    title: 'O nás - Arbovert s.r.o. | Certifikovaní arboristé od roku 2011',
    description: `Arbovert s.r.o. - tým certifikovaných arboristů s ${getYearsSinceFounded()}+ lety zkušeností. Specializujeme se na rizikové kácení, ošetřování stromů a údržbu zahrad.`,
    images: [
      {
        ...
        <div className="max-w-screen-lg mx-auto w-full pt-8 md:pt-20 pb-12 md:pb-20 px-4 md:px-6">
          ...
          <div className="grid grid-cols-12 gap-4 md:gap-10 mb-6 md:mb-10 bg-white rounded-2xl p-4 md:p-12 border-2 border-default-200">
            <div className="col-span-12 md:col-span-7 flex flex-col gap-4 md:gap-6">
              ...
              <p className="text-base md:text-lg text-default-600 leading-relaxed">
                Arboristice se věnujeme od roku 2011, od roku 2020 působíme jako
                společnost Arbovert s.r.o. Tým vede Lukáš Kačer, certifikovaný
                arborista. Naši arboristé jsou držiteli evropské certifikace ETW
                (European Tree Worker) a jsme členy Společnosti pro zahradní a
                krajinářskou tvorbu (SZKT).
              </p>
            </div>
