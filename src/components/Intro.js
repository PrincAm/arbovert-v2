    ...
    <div id="intro" className="max-w-screen-lg mx-auto w-full pt-20 px-6">
      <div className="grid grid-cols-12 gap-8 md:gap-10 justify-center">
        <div className="col-span-12 md:col-span-7 flex flex-col gap-6">
          <h2 className="leading-tight text-4xl md:text-6xl font-bold text-foreground">Co umíme</h2>
        ...
        <div className="col-span-12 md:col-span-7 flex flex-col gap-6 mt-8 md:mt-12">
          <h2 className="leading-tight text-4xl md:text-6xl font-bold text-foreground">
            Kácení stromů a arboristika
            <span className="block text-success-600 text-2xl md:text-4xl mt-2">
        ...
        <div className="col-span-12 md:col-span-7 flex flex-col gap-6 mt-8 md:mt-12">
          <h2 className="leading-tight text-4xl md:text-6xl font-bold text-foreground">Arboristika je náš život</h2>
          <p className="text-lg md:text-xl text-gray-600 leading-relaxed">
